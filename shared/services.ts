...
export const SERVICES: Service[] = [
  ...
  { name: 'Allstate Charlotte', category: 'insurance', description: 'Bundled auto and home insurance. Local agents across Charlotte.', phone: '(704) 541-7410', website: 'https://allstate.com', featured: false, affiliate: true, area: 'Charlotte Metro' },  { name: 'Lemonade Insurance', category: 'insurance', description: 'Digital-first renters and homeowners insurance. Instant online quotes.', phone: '', website: 'https://lemonade.com', featured: false, affiliate: true, area: 'Anywhere' },
...
// ========================================
  ...
  // --- Makeup Artists & Beauty (10) ---  { name: 'Sephora SouthPark', category: 'makeup', description: 'Premium cosmetics and beauty services. Makeovers and consultations.', phone: '(704) 365-3580', website: 'https://sephora.com', featured: false, affiliate: true, area: 'SouthPark Mall' },
