...
import { ArrowRight, Building2, CheckCircle2, ExternalLink, MapPin, Phone, Search, Shield, Star } from "lucide-react";
...
export default function DirectoryCategory() {
  ...
  const { data: activeTiers = [] } = trpc.premium.getActiveTiers.useQuery();
