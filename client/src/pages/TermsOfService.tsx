...
export default function TermsOfService() {
  ...
  const content: LegalPageContent = legalContent[locale].terms;
              ...
              <section key={section.id} aria-labelledby={headingId}>
                ...
                {section.blocks.map((block, blockIndex) =>
                  block.type === "paragraph" ? (
                    ...
                    >
                      {block.text}
                      {block.privacyLink && content.privacyLinkHref && content.privacyLinkLabel && (
                        <>
                          <Link href={content.privacyLinkHref} className="text-primary hover:underline">
